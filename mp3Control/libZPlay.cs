...
namespace libZPlay
{
    ...
    internal delegate int TCallbackFunc(uint objptr, int user_data, TCallbackMessage msg, uint param1, uint param2);



    internal enum TSettingID : int
    {
        sidWaveBufferSize = 1,
        sidAccurateLength = 2,
        sidAccurateSeek = 3,
    ...
    internal enum TStreamFormat : int
    {
        sfUnknown = 0,
        sfMp3 = 1,
        sfOgg = 2,
    ...
    internal enum TTimeFormat : uint
    {
        tfMillisecond = 1,
        tfSecond = 2,
        tfHMS = 4,
    ...
    internal struct TStreamLoadInfo
    {
        [FieldOffset(0)]
    ...
    internal enum TFFTGraphHorizontalScale : int
    {
        gsLogarithmic = 0,
        gsLinear = 1
    }

    internal enum TFFTGraphParamID : int
    {
        gpFFTPoints = 1,
        gpGraphType,
        gpWindow,
    ...
    internal enum TFFTGraphType : int
    {
        gtLinesLeftOnTop = 0,
        gtLinesRightOnTop,
        gtAreaLeftOnTop,
    ...
    [StructLayout(LayoutKind.Explicit)]
    internal struct TStreamHMSTime
    {
        [FieldOffset(0)]
        public uint hour;
        [FieldOffset(4)]
    ...
    internal enum TBPMDetectionMethod : int
    {
        dmPeaks = 0,
        dmAutoCorrelation
    }
    ...
    internal enum TFFTGraphSize : int
    {
        FFTGraphMinWidth = 100,
        FFTGraphMinHeight = 60
    }

    internal enum TWaveOutMapper : uint
    {
        WaveOutWaveMapper = 4294967295
    }

    internal enum TWaveInMapper : uint
    {
        WaveInWaveMapper = 4294967295
    }

    internal enum TCallbackMessage : int
    {
        MsgStopAsync = 1,
        MsgPlayAsync = 2,
        MsgEnterLoopAsync = 4,
    ...
    internal enum TWaveOutFormat : uint
    {
        format_invalid = 0,
    ...
    internal enum TWaveOutFunctionality : uint
    {
