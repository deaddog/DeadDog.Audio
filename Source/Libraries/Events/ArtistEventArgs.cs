...
{
    /// <summary>
    /// Provides data for the <see cref="DeadDog.Audio.Libraries.Artist.ArtistCollection.ArtistAdded"/> and the <see cref="DeadDog.Audio.Libraries.Artist.ArtistCollection.ArtistRemoved"/> events.
    /// </summary>
